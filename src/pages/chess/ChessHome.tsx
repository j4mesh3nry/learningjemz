...
import { Flame, Star, BookOpen, Gamepad2, ArrowLeft, Lock, ArrowRight, Swords, Bot, Zap, Puzzle } from 'lucide-react';
...
export default function ChessHome() {
  return (
    <Routes>
      ...
      <Route path="puzzles/*" element={<ErrorBoundary fallbackTitle="Chess Puzzle Error"><ChessPuzzlePage /></ErrorBoundary>} />
    </Routes>
  );
}
