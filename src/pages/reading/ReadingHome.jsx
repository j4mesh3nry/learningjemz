        ...
        <div className="reading-header-left">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <div style={{
              ...
              background: 'linear-gradient(135deg, #b85c1e 0%, #e07c3e 100%)', borderRadius: 10,
              boxShadow: '0 4px 10px rgba(224,124,62,0.3)'
            }}>
              📖
            </div>
            <h1 className="reading-page-title" style={{ margin: 0, color: '#d16f2c', fontSize: '1.6rem', fontWeight: 900 }}>Reading</h1>
          </div>
        </div>
